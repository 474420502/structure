...
func (node *Node[KEY, VALUE]) updateSize() {
	node.Size = getSize(node.Children[0]) + getSize(node.Children[1]) + 1
}

func getSize[KEY, VALUE any](cur *Node[KEY, VALUE]) int64 {
	if cur == nil {
		return 0
	}
	return cur.Size
...
func leftRotateWithRight[KEY, VALUE any](tree *Tree[KEY, VALUE], parent *Node[KEY, VALUE], child int) {
	...
	if children[0] != nil {
		children[0].Parent = cur
	}
	sub.Children[0] = children[1]
	if children[1] != nil {
		children[1].Parent = sub
	}
...
func rightRotateWithLeft[KEY, VALUE any](tree *Tree[KEY, VALUE], parent *Node[KEY, VALUE], child int) {
	...
	if children[1] != nil {
		children[1].Parent = cur
	}
	sub.Children[1] = children[0]
	if children[0] != nil {
		children[0].Parent = sub
	}
...
func leftRotate[KEY, VALUE any](tree *Tree[KEY, VALUE], parent *Node[KEY, VALUE], child int) {
	...
	if sub.Children[0] != nil {
		sub.Children[0].Parent = cur
	}
	sub.Children[0] = cur
	cur.Parent = sub
...
func rightRotate[KEY, VALUE any](tree *Tree[KEY, VALUE], parent *Node[KEY, VALUE], child int) {
	...
	if sub.Children[1] != nil {
		sub.Children[1].Parent = cur
	}
	sub.Children[1] = cur
	cur.Parent = sub
